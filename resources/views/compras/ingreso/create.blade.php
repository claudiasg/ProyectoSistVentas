	...
	<div class="row">
					...
					<div class="panel-body">
						...
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			            	<div class="form-group">
		            			...
		            			<input type="number"  name="pprecio_venta" id="pprecio_venta"   class="form-control" placeholder="P. Compra...">
			            	</div>
						</div>
		...
		<script>
			...
			function agregar(){
				...
				var precio_compra = document.getElementById("pprecio_compra").value;
